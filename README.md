...
See [HACS](https://github.com/custom-components/hacs), especially the **Add custom repositories** section on [this page](https://hacs.netlify.com/usage/settings/#add-custom-repositories).
